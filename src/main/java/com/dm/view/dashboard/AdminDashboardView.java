...
public class AdminDashboardView extends VerticalLayout {
        ...
        private com.vaadin.flow.component.Component createNavigationCards() {
                ...
                cards2.add(
                                ...
                                createIconNavigationCard("autorenew", "admin/generator", "Generator"));
        ...
        private HorizontalLayout createStatsRow() {
                ...
                // Structural Metrics
                // Structural Metrics
                stats.add(new com.dm.view.components.StatsCard("Faculties", String.valueOf(facultyService.count()),
                                "domain",
                ...
                stats.add(new com.dm.view.components.StatsCard("Specs", String.valueOf(specializationService.count()),
                                "school",
                                LumoUtility.TextColor.BODY));
