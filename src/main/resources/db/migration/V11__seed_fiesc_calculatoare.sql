...
VALUES (
        'ion.popescu@usv.ro',
        '$2a$10$o40p7mzIZxjzNXbsNJFzjeUMsqPxAv5EZzzmaPwYz/LJ8/JJQ.JBy',
        'TEACHER',
        1
    );
INSERT INTO users (email, password, role, enabled)
VALUES (
        'vasile.ionescu@usv.ro',
        '$2a$10$o40p7mzIZxjzNXbsNJFzjeUMsqPxAv5EZzzmaPwYz/LJ8/JJQ.JBy',
        'TEACHER',
        1
    );
...
VALUES (
        (
            SELECT id
            FROM users
            WHERE email = 'ion.popescu@usv.ro'
        ),
        'Ion',
        'Popescu',
        20,
        '[{"day":"MONDAY","weight":10}]'
    );
INSERT INTO teacher_profiles (
        user_id,
        first_name,
...
VALUES (
        (
            SELECT id
            FROM users
            WHERE email = 'vasile.ionescu@usv.ro'
        ),
        'Vasile',
        'Ionescu',
        20,
        '[{"day":"TUESDAY","weight":10}]'
    );
INSERT INTO teacher_profiles (
        user_id,
        first_name,
...
VALUES (
        (
            SELECT id
            FROM users
            WHERE email = 'maria.dumitrescu@usv.ro'
        ),
        'Maria',
        'Dumitrescu',
        18,
...
VALUES (
        (
            SELECT id
            FROM users
            WHERE email = 'elena.radu@usv.ro'
        ),
        'Elena',
        'Radu',
        22,
        '[{"day":"THURSDAY","weight":10}]'
    );
INSERT INTO teacher_profiles (
        user_id,
        first_name,
...
VALUES (
        (
            SELECT id
            FROM users
            WHERE email = 'gheorghe.stan@usv.ro'
        ),
        'Gheorghe',
        'Stan',
        20,
        '[{"day":"FRIDAY","weight":10}]'
    );
INSERT INTO teacher_profiles (
        user_id,
        first_name,
...
VALUES (
        (
            SELECT id
            FROM users
            WHERE email = 'constantin.gheorghiu@usv.ro'
        ),
        'Constantin',
        'Gheorghiu',
        20,
...
VALUES (
        (
            SELECT id
            FROM users
            WHERE email = 'mihai.matei@usv.ro'
        ),
        'Mihai',
        'Matei',
        24,
...
VALUES (
        (
            SELECT id
            FROM users
            WHERE email = 'florin.nistor@usv.ro'
        ),
        'Florin',
        'Nistor',
        20,
...
VALUES (
        (
            SELECT id
            FROM users
            WHERE email = 'roxana.dobre@usv.ro'
        ),
        'Roxana',
        'Dobre',
        20,
...
VALUES ('C-108', 'Fizică I', 'LECTURE', 4, 1, 'BOTH', 1);
-- Year 2
INSERT INTO courses (
        code,
        title,
...
VALUES (
        'C-404',
        'Criptografie şi securitate informaţională',
        'LECTURE',
        5,
        8,
        'BOTH',
